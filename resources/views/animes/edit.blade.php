  ...
  <div class="content d-flex justify-content-center">
    <form action="" method="post" class="w-50" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input value="{{ $anime->name }}" type="text" class="form-control" name="name">
      </div>
      <div class="mb-3">
        <label for="comment" class="form-label">Comment:</label>
        <input value="{{ $anime->comment }}" type="text" class="form-control" name="comment">
      </div>
      <div class="mb-3">
        <label for="comment" class="form-label">Image:</label>
        <input value="{{ $anime->img }}" type="file" class="form-control" id="image" aria-describedby="image"
      ...
      <div class="mb-3 d-flex align-items-center">
        ...
        <select class="form-select w-auto" aria-label="Select score" name="score">
          <option value="{{ $anime->score }}">{{ $anime->score }}</option>
